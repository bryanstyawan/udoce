    <div class="box box-primary" id="isi_sent">
                ...
                <table class="table table-hover table-striped">
                    ...
                    ?>
                        <tr>
                            ...
                            -->
                            <td class="mailbox-name" style="width: 300px" onClick="open_chat(<?=$list->id_pesan;?>,'sent');">
                                <a href="#"><?=$list->nama_pengirim;?></a>
                            </td>
                            <td class="mailbox-subject" style="width: 230px" onClick="open_chat(<?=$i;?>);">
